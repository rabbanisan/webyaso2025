...
class Terima extends CI_Controller {
	...
	public function rpl()
	{
		...
		$this->load->view('komponen/header', $data);
		$this->load->view('komponen/navbar', $data);
		$this->load->view('Admin/Terima/Jurusan/rpl', $data);
		//$this->load->view('komponen/footer', $data);
	}
	public function AK()
	{
		...
		$this->load->view('komponen/header', $data);
		$this->load->view('komponen/navbar', $data);
		$this->load->view('Admin/Terima/Jurusan/Ak', $data);
		//$this->load->view('komponen/footer', $data);
	}
	public function AP()
	{
		...
		$this->load->view('komponen/header', $data);
		$this->load->view('komponen/navbar', $data);
		$this->load->view('Admin/Terima/Jurusan/AP', $data);
		//$this->load->view('komponen/footer', $data);
	}
 ...
 // Create new Spreadsheet object
	...
	public function edit($id){
		...
		$this->form_validation->set_rules('nisn', 'nisn', 'trim|required|max_length[25]|is_unique[siswa.nisn]|regex_match[/^[A-Za-z0-9\s]+$/]',['is_unique'=>'nisn telah terdaftar', 'max_length'=>'maximal 25 huruf', 'required'=>'NISN Tidak Boleh Kosong','trim'=>'tidak boleh mengandung spasi', 'regex_match'=>'tidak boleh mengandung simbol']);
		...
		public function update(){
			$agama = "";
		if($this->input->post('LainnyaA') == 'lainnya'){
			$agama = $this->input->post('agama_l');
		}else{
			$agama = $this->input->post('agama');
		}
		$sumber = "";
		if($this->input->post('LainnyaS')=='lainnya'){
			$sumber = $this->input->post('sumber_l');
		}else{
			$sumber = $this->input->post('sumber');
		}
