    ...
    <div class="container">
      ...
      <div class="row align-items-center">
        <div class="col-md-6">
          <p class="mb-4 fs-5">
            Jurusan
            <span class="fw-semibold">Pengembangan Perangkat Lunak dan Gim (PPLG)</span>
        ...
        <div class="col-md-4 mb-4 d-flex justify-content-center">
          <div class="card-hover h-100 w-100 border rounded shadow-sm p-4 bg-white justify-content-start">
            <div class="card-body d-flex align-items-center gap-3">
              ...
              <h4 class="fw-semibold">Software Development</h4>
            </div>
            <ul class="list-unstyled">
              <li class="mb-2">
        ...
        <div class="col-md-4 mb-4 d-flex justify-content-center">
          <div class="card-hover h-100 w-100 border rounded shadow-sm p-4 bg-white justify-content-start">
            <div class="card-body d-flex align-items-center gap-3">
              ...
              <h4 class="fw-semibold">Teknologi Web</h4>
            </div>
            <ul class="list-unstyled">
              <li class="mb-2">
        ...
        <div class="col-md-4 mb-4 d-flex justify-content-start">
          <div class="card-hover h-100 w-100 border rounded shadow-sm p-4 bg-white">
            <div class="card-body d-flex align-items-center gap-3">
              <i
                class="bi bi-code-slash text-info display-4"></i>
              <h4 class="fw-semibold">Karir Lainnya</h4>
            </div>
            <ul class="list-unstyled">
              <li class="mb-2">
