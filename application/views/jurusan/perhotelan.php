...
<body>
    ...
    <section id="tentang" class="py-5">
      <div class="container">
        <h2 class="section-title mb-4">Tentang Jurusan Perhotelan</h2>
        <div class="row align-items-center">
          <div class="col-md-6">
            <p class="mb-4 fw-semibold">
              Jurusan
              <span class="fw-bold">Perhotelan</span>
    ...
    <!-- Prospek Karir -->
    <section id="prospek-karir" class="py-5">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4 mb-4">
            <div class="card-hover card h-100">
              <div class="card-body text-center">
                <i
                  class="bi bi-person-badge-fill text-primary display-4 mb-4"
                ></i>
                <h4>Manajer Hotel</h4>
              </div>
            </div>
          ...
          <div class="col-md-4 mb-4">
            <div class="card-hover card h-100">
              <div class="card-body text-center">
                <i class="bi bi-reception-4 text-primary display-4 mb-4"></i>
          ...
          <div class="col-md-4 mb-4">
            <div class="card-hover card h-100">
              <div class="card-body text-center">
                <i class="bi bi-brush text-primary display-4 mb-4"></i>
        ...
        <div class="row mt-4">
          <div class="col-md-4 mb-4">
            <div class="card-hover card h-100">
              <div class="card-body text-center">
                <i class="bi bi-utensils text-primary display-4 mb-4"></i>
          ...
          <div class="col-md-4 mb-4">
            <div class="card-hover card h-100">
              <div class="card-body text-center">
                <i class="bi bi-calendar-event text-primary display-4 mb-4"></i>
                <h4>Event Manager</h4>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4 mb-4">
            <div class="card-hover card h-100">
              <img
                src="hotel-training.jpg"
                class="card-img-top"
                alt="Training Perhotelan"
              />
              <div class="card-body">
                <h5 class="card-title">Pelatihan Perhotelan</h5>
                <p class="card-text">
                  Siswa sedang mengikuti pelatihan perhotelan di hotel
                  berbintang.
                </p>
              </div>
            </div>
          ...
          <div class="col-md-4 mb-4">
            <div class="card-hover card h-100">
              ...
              <div class="card-body">
                ...
                <p class="card-text">
                  Siswa belajar tentang manajemen event dalam program MICE.
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-4 mb-4">
            <div class="card-hover card h-100">
              <img
                src="guest-service.jpg"
                class="card-img-top"
                alt="Pelayanan Tamu"
              />
              <div class="card-body">
                <h5 class="card-title">Pelayanan Tamu</h5>
                <p class="card-text">
