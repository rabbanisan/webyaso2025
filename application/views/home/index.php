...
.carousel-item {
          position: relative;
          height: 60vh; /* Menyesuaikan tinggi gambar dengan viewport */
      }
      ...
      .carousel-item img {
          ...
          height: 100%;
          width: 100%;
          filter: brightness(0.5); /* Menggelapkan gambar */
      }
      ...
      .carousel-control-next-icon {
          background-color: rgba(0, 0, 0, 0.5); /* Mengatur warna ikon jika diperlukan */
      }
      ...
      @media (max-width: 768px) {
          .carousel-item {
              height: 45vh; /* Menyesuaikan tinggi gambar untuk perangkat kecil */
          }
          ...
          .carousel-control-prev,
          .carousel-control-next {
              display: none; /* Menyembunyikan tombol navigasi pada tampilan kecil */
          }
  
          .carousel-indicators {
              bottom: 10px; /* Menurunkan posisi indikator */
          }
      }
...
<div class="brosur-container">
        <div class="brosur-content">
            <div class="brosur-item">
                <img src="<?= base_url();?>Assets/img/imageInfo/ppdb1.jpeg" alt="PPDB 1" class="brosur-image">
                
            </div>
            <div class="brosur-item">
            <img src="<?= base_url();?>Assets/img/imageInfo/ppdb2.jpeg" alt="PPDB 2" class="brosur-image">
                
            </div>
            <div class="brosur-item">
            <img src="<?= base_url();?>Assets/img/imageInfo/ppdb3.jpeg" alt="PPDB 3" class="brosur-image">
...
Puji syukur kita panjatkan kehadirat Tuhan Yang Maha Esa atas segala rahmat dan karunia-Nya sehingga kita dapat terus menjalankan tugas mulia dalam mencerdaskan kehidupan bangsa. Kami mengucapkan selamat datang di website resmi SMK Yadika Soreang, yang merupakan media informasi dan komunikasi yang diharapkan mampu memenuhi kebutuhan informasi seputar kegiatan dan prestasi sekolah kami. Saya mengajak seluruh guru, siswa, orang tua, dan alumni untuk turut serta dalam mengisi dan mengembangkan website ini yang dapat memberikan masukan dan saran yang konstruktif agar website ini dapat menjadi lebih baik lagi. Mari kita bersama-sama menjadikan website ini sebagai wadah untuk berkreasi dan berinovasi dalam dunia pendidikan.
  ...
  <style>
      ...
      .facts-section {
        background-color: #007bff; /* Background biru untuk seluruh section */
        padding: 50px 0;
      }
      ...
      .facts-card {
        ...
        border-radius: 10px;
        margin-bottom: 20px;
        color: #fff; /* Warna teks putih untuk kontras dengan background biru */
      ...
      .facts-card h2 {
        font-size: 2.5rem; /* Ukuran angka tetap */
        margin: 0;
      }

      .facts-card p {
        margin: 0;
        color: #e0e0e0; /* Warna teks sedikit lebih terang untuk kontras yang lebih baik */
