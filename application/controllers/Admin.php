...
class Admin extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['RPL_terima'] = $this->db->query("SELECT COUNT(*) as RPL FROM siswa WHERE tahun = $tahun AND ket = 1 AND jurusan = 'RPL'")->result_array();
		$data['AK_terima'] = $this->db->query("SELECT COUNT(*) as AK FROM siswa WHERE tahun = $tahun AND ket = 1 AND jurusan = 'AK'")->result_array();
		$data['AP_terima'] = $this->db->query("SELECT COUNT(*) as AP FROM siswa WHERE tahun = $tahun AND ket = 1 AND jurusan = 'AP'")->result_array();
