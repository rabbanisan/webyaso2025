    ...
    <div class="home-container">
      <div class="text-container">
        <div class="text-home">
        <h1>Visi</h1>
        <P>Visi SMK Yadika Soreang adalah mewujudkan generasi masa kini yang berakhlak mulia, kompeten dan profesional sesuai bidangnya, serta dapat berkontribusi bagi diri sendiri, keluarga, dan masyaraka</P>  
        <h1>Misi</h1>

        <h1>Profile Sekolah</h1>
          <p>
            Kenalan dengan beberapa Guru dan beberapa Fasilitas yang tersedia di
            SMK Yadika Soreang Yuk!
          </p>
        </div>
      </div>
